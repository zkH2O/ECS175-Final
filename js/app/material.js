...
class Material {
     ...
     * @param {Number} refractiveIndex Optional refractive index for glass-like materials (default: 1.5)
     */
    constructor(
        kA = [0, 0, 0],
        kD = [0, 0, 0],
        ...
        this.refractiveIndex = refractiveIndex; // Refractive index for materials like glass
    }
